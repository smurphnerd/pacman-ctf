...
def readCommand(argv):
  ...
  """
    ...
    parser.add_option("-r", "--red", help=default("Red team"), default="berkeleyTeam")
    parser.add_option("-b", "--blue", help=default("Blue team"), default="berkeleyTeam")
    ...
    parser.add_option(
        ...
        dest="results_out",
        type="string",
        help=default("Path to write JSON results file"),
        default=None,
    )
