...
class MixedAgent(CaptureAgent):
    ...
    def chooseAction(self, gameState: GameState):
        ...
        print(self.highLevelPlan[self.currentActionIndex][0].parameters)
    ...
    def getGoals(self, objects: List[Tuple], initState: List[Tuple]):
        ...
        # If we're scared (capsule eaten), we're useless on defense - GO ATTACK!
        if is_scared and not is_pacman:
            # Scared ghost should attack (can't catch invaders anyway)
